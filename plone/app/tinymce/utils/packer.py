...
def run():
    ...
    files = [
        'classes/tinymce.js',
        'classes/adapter/jquery/adapter.js',
        'classes/util/Dispatcher.js',
        'classes/util/URI.js',
#        'classes/util/Cookie.js',
#        'classes/util/JSON.js',
#        'classes/util/XHR.js',
#        'classes/util/JSONRequest.js',
        'classes/dom/DOMUtils.js',
        'classes/dom/Event.js',
        'classes/dom/Element.js',
        'classes/dom/Selection.js',
#        'classes/dom/XMLWriter.js',
#        'classes/dom/StringWriter.js',
#        'classes/dom/Serializer.js',
        'classes/dom/SerializerDummy.js',
